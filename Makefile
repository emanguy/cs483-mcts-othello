...
mcts-parallel: monteCarloTreeSearch-parallel.c board.c node.c mpitimer.o
	mpicc -g -Wall mpitimer.o board.c node.c monteCarloTreeSearch-parallel.c -o monteCarloTreeSearch-parallel.out -lm
